        ...
        return(
            <div>
                ...
                <form onSubmit={submit}>
                    ...
                    <button className='login-button' >LOGIN</button>|<Link to={'/signup'}><small className='login-small'>sign up</small></Link><br/> <Link to={'/recover'}><small style={{marginTop:'60px'}}>forgot passsword?</small></Link>
                </form>
                </div>
                <Footer/>
            </div>
